...
#    return F
#
#def integrator_cumusimp(f, x, x0=0):
#    F = x0 + np.sum(((x[2::2] - x[:-2:2])/6) * (f[2::2] + 4*f[1:-1:2] + f[:-2:2]))
#    return F
...
E       = 72.9          ## material Young's modulus                     [GPa]
G       = 27.1          ## material shear moduus                        [GPa]
...
if export:
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/sigxx_top.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/sigxx_bot.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/sigxx_spar.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/q_top.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/q_bot.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/q_spar.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/sigvm_top.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/sigvm_bot.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
    ...
    ax[0,0].tick_params(which='major', length=10, width=2, direction='inout')
    ax[0,0].tick_params(which='minor', length=5, width=2, direction='in')
    fig.savefig("SavedFiles/{}/sigvm_spar.png".format(Aircraft), bbox_inches='tight')
    counter +=1
    print("\rTotal files saved : %05d/%05d"%(counter, totalfiles), end="", flush=True)
    plt.close("all")
...
if DDDplot:
    t_total += t_pe-t_ps
print("\t\t      + -----------")
print("Total Execution Time \t= {:.3f} \ts".format(t_total))
